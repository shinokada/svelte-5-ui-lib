<script lang="ts">
  ...
  const closeDemoModal = modalExample.close;
  $effect(() => {
...
<Modal title="Terms of Service"  modalStatus={modalStatus} closeModal={closeDemoModal}>
  {#snippet footer()}
  <Button on:click={() => alert('Handle "success"')}>I accept</Button>
  <Button color="alternative" onclick={closeDemoModal}>Decline</Button>
  {/snippet}
  <!-- Modal body -->
