...
export const modal = tv({
  slots: {
    base: 'fixed top-0 start-0 end-0 h-modal md:inset-0 md:h-full z-50 w-full p-4 flex',
    div: 'flex relative w-full max-h-full',
    content: 'w-full divide-y text-gray-800 dark:text-gray-300 border-gray-300 dark:border-gray-800 divide-gray-300 dark:divide-gray-800 bg-white dark:bg-gray-800',
    // backdrop: 'fixed top-0 start-0 z-50 w-full h-full'
    backdrop: 'fixed inset-0 z-50 bg-gray-900 bg-opacity-50 dark:bg-opacity-80',
